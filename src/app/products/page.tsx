                ...
                >
                  ...
                  <div className="relative h-60 w-full bg-[#F5F5F5] flex items-center justify-center p-8 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 z-20 w-3/4">
                      <Link href={`/products/${getPrimaryCategory(product).toLowerCase().replace(/ & | /g, '-')}/${product.slug}`} className="block w-full text-center bg-[#111] text-white font-syncopate text-[10px] uppercase tracking-widest py-3 hover:bg-black transition-colors shadow-lg">
                        View Details
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="pt-5 pb-5 px-5 flex flex-col flex-1 bg-white z-10 relative border-t border-gray-100">
                    ...
                    <div className="mt-auto flex items-end justify-between">
                      <Link href={`/products/${getPrimaryCategory(product).toLowerCase().replace(/ & | /g, '-')}/${product.slug}`} className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-[#111] group-hover:bg-[#111] group-hover:text-white transition-colors ml-auto">
