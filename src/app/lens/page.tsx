...
const brands = ["Sony", "Fujifilm", "Canon", "Nikon"];
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            >
              <div className="sticky top-32 space-y-10 bg-background lg:bg-transparent pb-6 lg:pb-0 z-10">
                ...
                {/* Brands */}
                <div>
                  <h3 className="font-syncopate text-sm font-bold tracking-widest text-[#111] mb-4">
                    BRANDS
                  </h3>
