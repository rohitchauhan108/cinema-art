...
export default function accessoriesPage({
  ...
  // Find accessories by slug
const accessories = accessoriesData.find(
...
console.log("Found:", accessories);
  ...
  const activeColor = accessories.colors[activeColorIdx];
  const nextImage = () =>
      ...
      <main className="min-h-screen bg-backgroundd pt-40 pb-24">
        <div className="max-w-350 mx-auto px-6 md:px-12">
          ...
          >
            ...
            >
              <ArrowLeft className="w-3 h-3" /> Back to accessories
            </Link>
            <span>/</span>
            <span className="capitalize">{accessories.category}</span>
            <span>/</span>
            <span className="text-[#111] font-medium">{accessories.name}</span>
          </motion.div>
                ...
                >
                  <AnimatePresence mode="wait">
                    <motion.img
                      ...
                      alt={`${accessories.name} - ${activeColor.name}`}
              ...
              {accessories.colors && accessories.colors.length > 0 && (
                <div className="mb-8">
                  ...
                  <div className="flex gap-3">
                    {accessories.colors.map((color, idx) => (
                      <button
                        key={idx}
          ...
          <div className="mt-32 border-t border-gray-300 pt-24">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-20">
              {accessories.richFeatures.map((feat, idx) => (
                <div 
                  key={idx}
          ...
          {accessories.specs && accessories.specs.length > 0 && (
            <div className="mt-32 max-w-4xl mx-auto border-t border-gray-300 pt-20">
              ...
              <div className="space-y-4">
                {accessories.specs.map((specGroup, idx) => (
                  <div
                    key={idx}
